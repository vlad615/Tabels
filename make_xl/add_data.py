...
class AddData:
    ...
    def __init__(self, table: str, photo: str):
        colors = ["Бежевый", "Белый", "Бирюзовый", "Голубой", "Жёлтый", "Зелёный", "Коричневый", "Красный", "Оранжевый",
                  "Розовый", "Серебристый", "Серый", "Синий", "Фиолетовый", "Чёрный", "Разноцветный", "Другой"]
        self.table = table
        self.root2 = Tk()
        ...
        self.variables = {
            ...
            "tables": {"TableType": ["Письменный", "Кухонный", "Барный", "Журнальный", "Другой"],
                       "FurnitureShape": ["Прямоугольный", "Квадратный", "Круглый", "Полукруглый", "Угловой"],
